 ...
 * 添加红包账号信息
 */
public class F100009 extends BaseFunction  {
    @Override
    ...
    private void insert(String phone,String list) throws Exception {
        ...
        arg[0]=phone;
        String sql="delete from t_accout where type ='hongbao' and phone=? ";
        ...
        for(Map<String,String> dataRow : accoutList){
            if(dataRow!=null){
                ...
                sql="INSERT INTO t_accout(phone,number,accout,type,state,update_time) VALUES (?,?,?,'hongbao','1',now())";
    ...
    public static void main(String arg[] ) throws Exception{
        ...
        F100009 f = new F100009();
        f.insert("c4c8ba9f4fd2","[{n:1,a:15889649769},{n:2,a:15889649769},{n:3,a:15889649769},{n:4,a:15889649769},]");
    }
}
