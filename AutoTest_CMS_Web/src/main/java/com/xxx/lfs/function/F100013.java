...
public class F100013 extends BaseFunction   {
	...
	public ResponseParameter execute(RequestParameter requestParameter) throws Exception {
		...
		insert(version,remark,url);
		return response;
	}
	private int insert(String version,String remark,String url) throws Exception {
		...
		if(id==null){
			...
			arg[1]=remark;
			arg[2]=url;
			String sql="INSERT INTO t_update(version,remark,url,state,update_time) VALUES (?,?,?,'1',now())";
			...
			arg[2]=url;
			arg[3]=id;
			String sql="update t_update set version=? ,remark=? ,url=? ,update_time=now() where id=?";
			return getNewJdbcTemplate().update(sql,arg);
		}
	}
	...
	public static void main(String arg[] ) throws Exception{
		...
		f.insert("花椒助手_2.0_","测试1","http://www.163.com");
	}
}
