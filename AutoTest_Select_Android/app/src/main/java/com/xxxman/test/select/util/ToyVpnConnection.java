...
/**
 * Created by Drizzt on 2017-10-25.
 */
public class ToyVpnConnection implements Runnable{
    /**
     * Callback interface to let the {1@link ToyVpnService} know about new connections
    ...
    public ToyVpnConnection(final VpnService service, final int connectionId, final String serverName, final int serverPort, final byte[] sharedSecret) {
        mService = service;
